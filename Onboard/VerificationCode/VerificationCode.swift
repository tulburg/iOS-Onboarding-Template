...
@IBDesignable open class VerificationCode: UIControl {
    ...
    @IBInspectable public var underlineVerticalSpacing: CGFloat = 10
    ...
    @IBInspectable public var fontSize: CGFloat = 32 {
        didSet {
    ...
    init(_ numel: Int, itemWidth: CGFloat) {
        super.init(frame: CGRect())
        self.underlineColor = .blackWhite
        self.numel = numel
        self.underlineHeight = 0
        self.itemWidth = itemWidth
        self.codeBackgroundCornerRadius = 8
        self.codeBackgroundColor = .separatorLight
        setup()
    }
